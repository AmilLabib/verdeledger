      ...
      >
        ...
        <span
          className={`transition-all duration-300 ease-in-out origin-left ${
            collapsed ? 'opacity-0 translate-x-[-6px] w-0 overflow-hidden' : 'opacity-100 translate-x-0'
          }`}
        >
          {label}
        </span>
    ...
    <>
      ...
      >
        <div className="mb-6 flex items-center justify-between">
          <div className={`transition-all duration-300 ease-in-out ${collapsed ? 'w-8' : 'w-40'}`}>
            <img src="/logo.png" alt="logo" className={`block ${collapsed ? 'w-8' : 'w-20'}`} />
          </div>
