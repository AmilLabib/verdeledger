  ...
  return (
    <div className="min-h-screen">
      ...
      <p className="text-sm text-gray-600 mb-6">
        Sustainability Certifications for Your Enterprise
      </p>
        ...
        <aside className="space-y-4">
          <div className="bg-white rounded-xl p-4 shadow">
            <h4 className="font-semibold mb-2">
              Financial Reporting Progress Checklist
            </h4>
            <ul className="text-sm space-y-2">
              ...
              <li className="flex justify-between">
                <span>Define Carbon & Financial Metrics</span>
                <span>✔️</span>
              </li>
              <li className="flex justify-between">
                <span>Run Green & Profit Forecast</span>
                <span>✔️</span>
              </li>
              <li className="flex justify-between">
                <span>Review Impact Dashboard</span>
                <span>✔️</span>
              </li>
              <li className="flex justify-between">
          ...
          <div className="bg-white rounded-xl p-4 shadow">
            ...
            <BenchmarkChart yourScore={80} industryAvg={70} />
          </div>
        </aside>
      </div>
